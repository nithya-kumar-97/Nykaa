...
public class Base_Class {
	...
	public static void takesSreenShot(String imageName) throws IOException {
		TakesScreenshot screenshot = (TakesScreenshot) driver;
		File sourceFile = screenshot.getScreenshotAs(OutputType.FILE);
		File destinationFile = new File("F:\\Selenium\\Project\\Screenshot" + imageName + ".png");
	...
	public static void explicitWait(Duration time, String condition, By element) {
	...
	public static void findElementsMethod(List<WebElement> list, String givenData) {

		for (WebElement getList : list) {
			getText(getList);
			if (getList.getText().equalsIgnoreCase(givenData)) {
				click(getList);
			}
		}
	}
